...
export function SolutionsSection() {
  ...
  return (
    <Section
      ...
      className="relative z-10 !bg-white py-16 sm:py-20 lg:py-16 xl:py-20"
      revealOnView={false}
    >
      <div className="w-full px-6 lg:mx-auto lg:max-w-[90rem] lg:px-10 xl:max-w-[100rem] xl:px-12">
        <div className="w-full rounded-2xl bg-[#f1f4f6] px-6 py-12 sm:px-8 sm:py-14 lg:px-16 lg:py-16 xl:px-20 xl:py-20">
          <SectionHeader
