export const en = {
  ...
  showcase: {
    title: "Selected work",
    subtitle:
      "Examples of engagements where we helped teams ship dependable software and simplify complex operations.",
    labels: {
      challenge: "Challenge",
      delivery: "Delivery",
      outcome: "Outcome",
    ...
    items: [
      {
        clientLabel: "Regional manufacturer",
        industry: "Manufacturing",
        challenge:
          "Disconnected systems and manual reporting slowed operational decisions.",
        delivery:
          "Integration layer and role-based operational dashboards tied to ERP data.",
        outcome:
          "Reporting cycle reduced from days to hours; clearer audit trail for operations.",
        tags: ["Integration", "Custom app", "Azure"],
      },
      {
        clientLabel: "B2B logistics platform",
        industry: "Logistics",
        challenge:
          "Order flows struggled to keep up with seasonal volume and partner integrations.",
        delivery:
          "Cloud-native services and APIs to stabilize peak-season throughput.",
        outcome:
          "More predictable processing at peak load; fewer manual interventions.",
        tags: ["Cloud-native", "APIs", ".NET"],
      },
      {
        clientLabel: "Professional services firm",
        industry: "Professional services",
        challenge:
          "Project delivery and finance data lived in separate tools with no single view.",
        delivery:
          "Unified workspace for engagement tracking, delivery, and billing alignment.",
        outcome:
          "One source of truth for active engagements and financial visibility.",
        tags: ["Custom app", "Workflow", "Integration"],
      },
    ],
  },
  deal: {
  ...
  contact: {
    ...
    engagementOptions: {
      fixed: "Fixed-scope project",
      time: "Time-based engagement",
